...
ok(
  $headersHref->{snp_1}[0] eq 'Fragment',
...
ok( $#{ $headersHref->{snp_2} } == 5,
  'Can dereference array ref and get last index' );

ok( $#{ $headersHref->{snp_1} } == 4,
  'Can dereference array ref and get last index 2' );
